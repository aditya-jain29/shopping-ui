...
const headCells = [
    { id: 'itemId', numeric: false, disablePadding: true, label: 'Item Id' },
    { id: 'itemName', numeric: true, disablePadding: false, label: 'Item Name' },
    { id: 'sellPrice', numeric: true, disablePadding: false, label: 'Sell Price' },
            ...
            {numSelected > 0 ? (
                <Tooltip title="Delete">
                    <IconButton aria-label="delete">
                        <AddShoppingCartIcon onClick={props.onAddToCart}/>
                    </IconButton>
                </Tooltip>
            ) : (
    ...
    return (
      <div className={classes.root}>
          <Paper className={classes.paper}>
              <EnhancedTableToolbar numSelected={selected.length} onAddToCart={addToCartFunc}/>
              <TableContainer>
                  <Table
                      className={classes.table}
                      aria-labelledby="tableTile"
